...
class fps_officer
{
    const POST_TYPE     = "fps-officer";
    const POST_TAXONOMY = "officer-type";
    ...
    public static function registerTaxonomy()
    {
        register_taxonomy(
            ...
            self::POST_TYPE,
            array(
                'label' => __( 'Officer Type', RW_TEXT_DOMAIN),
        ...
        register_taxonomy(
            ...
            self::POST_TYPE,
            array(
                'label' => __('Officer Position', RW_TEXT_DOMAIN),
                'hierarchical' => true,
                'show_admin_column' => true,
            )
        );
