...
class WPSearch
{
    ...
    */
    ...
    public static function search_posts($term)
    {
        global $wpdb;
        $args = array(
            'post_type' => array('post', 'press-release', 'news', 'position-paper', 'member', 'page'),
            'post_status' => 'publish',
            's' => $term,
        );
        ...
        WHERE (
            ...
            OR wp_posts.post_type = 'press-release'
            OR wp_posts.post_type = 'news'
            OR wp_posts.post_type = 'position-paper'
            OR wp_posts.post_type = 'member'
