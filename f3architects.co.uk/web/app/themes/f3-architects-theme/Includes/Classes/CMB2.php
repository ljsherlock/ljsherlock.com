...
class CMB2
{
    ...
    public static function init()
    {
        ...
        add_action( 'cmb2_admin_init', array( __CLASS__, 'ljsherlock_register_services_meta') );
    }
    ...
    * @method Pages
    ...
    public static function ljsherlock_register_front_page_meta()
    {
			...
			$frontPageLinks = CMB2::getFrontPageLinks('type', array('hide_empty' => false));
     ...
     * @
     */
    public static function ljsherlock_register_services_meta() {
      ...
      $args = array(
        ...
        'orderby' => 'date',
			...
			$servicesOptions = CMB2::returnPostOptions($args);
			$linkToArchive = CMB2::getFrontPageLinks('type', array('hide_empty' => false));

      $cmb_services = new_cmb2_box( array(
          'id'           => self::$prefix . 'services',
      ...
      $cmb_services_group = $cmb_services->add_field(array(
          'id'   => self::$prefix . 'services_post_group',
          'type' => 'group',
          'title' => 'Services',
          'description' => __( 'Select the list of Work Projects to show', 'cmb2' ),
          'repeatable'  => true, // use false if you want non-repeatable group
          'options'     => array(
            'group_title'   => __( 'Item {#}', 'cmb2' ), // since version 1.1.4, {#} gets replaced by row number
            'remove_button' => __( 'Remove post', 'cmb2' ),
      ...
      $cmb_services->add_group_field($cmb_services_group, array(
          'name' => esc_html__( 'Title', 'cmb2' ),
          'id'   => 'title',
          'type' => 'text',
      ));
      ...
      $cmb_services->add_group_field($cmb_services_group, array(
          'name' => esc_html__( 'Service Plural', 'cmb2' ),
          'id'   => 'plural',
          'type' => 'text',
      ));
